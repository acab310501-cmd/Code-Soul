          ...
          return `
            ...
            >
              ...
              >
                ...
                <div class="work-project__number">
                  ${project.number}
                </div>
  ...
  return `
    ...
    >
      ...
      <div class="work-case__top">
        ...
        <span class="work-case__eyebrow">
          ${data.eyebrow}
        </span>

        <button
          class="work-case__close"
          type="button"
          data-case-close
      ...
      <div class="work-case__hero">
        ...
        <div class="work-case__hero-label">
          ${project.number} / ${project.title}
        </div>

        <h4 class="work-case__hero-title">
          ${data.introTitle}
        </h4>

        <p class="work-case__intro">
          ${data.intro}
        </p>
      ...
      <div class="work-case__story">
        ...
        <div class="work-case__chapter">
          ...
          <div class="work-case__chapter-index">
            01
          </div>

          <div>

            <span class="work-case__chapter-label">
              ${data.challengeTitle}
            </span>
      ...
      <div class="work-case__gallery">
        ...
        <div class="work-case__gallery-header">
      ...
      <div class="work-case__result">
        ...
        <span class="work-case__result-label">
          ${data.resultTitle}
        </span>
...
function openCase(
  ...
  gsap.to(
    caseElement,
    {
      ...
      onComplete() {
        ...
        caseElement.style.height =
          "auto";

        caseElement.style.overflow =
          "visible";
  ...
  gsap.fromTo(
    caseElement.querySelectorAll(
      ".work-case__hero > *, .work-case__chapter, .work-case__result, .work-case__live"
    ),
    {
      opacity: 0,
      y: 35,
